...
- After making code changes, run `bun check-all-for-ai` to execute all tests (takes up to 1 hour), or `bun check-for-ai` for only type checking and linting (takes up to 10 minutes).
